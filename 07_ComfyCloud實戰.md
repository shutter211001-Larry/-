...
### 2.2 實作一：抽盲盒地獄
*(預計時間：30 分鐘)*
*   打開 **【Comfy Cloud】分頁** ➔ 找到畫面中央的 **【KSampler】** 節點，將它的 `seed` 屬性設定為 `randomize` ➔ 點擊右上角的 **【Queue Prompt】** 按鈕生成一張滿意的圖片 ➔ 稍微修改你的 Prompt 文字 ➔ 再次點擊 **【Queue Prompt】**。
...
*   在上方的 **【Load Image】** 節點上傳一張有明確骨架或邊緣線的參考圖 ➔ 用滑鼠左鍵點住原圖的黃色小圓點，拖曳連線到 ControlNet 的輸入端 ➔ 再次點擊右上角的 **【Queue Prompt】**。
