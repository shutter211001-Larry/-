...
### 4.2 實作三：精準描圖
*(預計時間：25 分鐘)*
*   在畫布空白處點擊右鍵 ➔ 加入 **【ControlNet Apply】** 與 **【Load Image】** 節點。
*   上傳一張有明確骨架或邊緣線的參考圖 ➔ 將它連上 ControlNet ➔ 再次點擊 **【Queue Prompt】**。
...
* 將錯誤的 VAE 節點刪除，重新連接正確對應 FLUX 的 `ae.safetensors` VAE ➔ 再次生成。
